...
teams = Team.create([
    ...
    {sport_id: sports[1].id, team_name: 'Lions', city: 'Detroit', roster: 'Goff, Peterson, Golladay, Swift, Griffen, Jones, Trufant', coach: "Dan Campbell", sport_name: sports[1].sport_name},
...
favorites = Favorite.create([
    {user_id: users[2].id, team_id: teams[5].id},
